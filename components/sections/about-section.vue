...
<script>
const aboutText = [
  'На протяжении последних шести лет занимаюсь разработкой IT-продуктов.',
  ...
  'Ценю красоту во всем, катаюсь на скейте, играю в шахматы, учусь рисовать, залипаю на горы и море.',
